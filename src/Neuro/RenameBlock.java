...
public class RenameBlock implements Runnable {
    ...
    private File fileToSave = new File("C:\\Neuro.Postironia\\Neuro.Z\\renameBlock.txt");
    ...
    public void run() {
        ...
        File fileMark = new File("C:\\Neuro.Postironia\\ZN\\mark.txt");
        File fileImage = new File("C:\\Neuro.Postironia\\ZN\\image.jpg");
        File fileQuestions = new File("C:\\Neuro.Postironia\\ZN\\text.txt");
        try {
            while (true) {
